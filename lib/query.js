...
// In addition to exposing the `query` function, also export
// helper functions with lower-level functionality.
// > These are attached as properties of the `query` function.
